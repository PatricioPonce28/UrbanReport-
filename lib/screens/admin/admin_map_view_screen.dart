...
class AdminMapViewScreen  extends StatefulWidget {
  ...
  @override
  State<AdminMapViewScreen > createState() => _MapViewScreenState();
}

class _MapViewScreenState extends State<AdminMapViewScreen> {
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            Text(
                              'No tienes reportes con ubicación',
                              style: TextStyle(
                                fontSize: 16,
                            ...
                            Text(
                              'Crea un reporte con ubicación para verlo aquí',
                              style: TextStyle(
                                fontSize: 14,
